...
public class LoginControllers {
	...
	public String login(Model m, @RequestParam("uname") String name, @RequestParam("pwd") String pwd) {
		if ((name.equals("admin") || name.equals("admin"))
				&& (pwd.equals("Arjun@397") || pwd.equals("root"))) {
	...
	public String Register(Model m, @RequestParam("fname") String name, @RequestParam("pwd") String pwd,
			@RequestParam("uname") String uname, @RequestParam("email") String mail, @RequestParam("mobile") String mob) {
